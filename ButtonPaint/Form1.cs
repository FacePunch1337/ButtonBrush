...
namespace ButtonPaint
{
    public partial class Form1 : Form
    {
        ...
        struct BrushButton  
        {
            ...
            public static int squeezedX = 0;
            public static int squeezedY = 0;
        ...
        {
            BrushButton.squeezedX = e.X;
            BrushButton.squeezedY = e.Y;
            BrushButton.isReleas = false;
